...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 bg-[#030914]/60 backdrop-blur-2xl border-b border-white/10 shadow-lg">
            ...
            <AnimatePresence>
                {mobileOpen && (
                    <motion.nav
                        ...
                        className="lg:hidden overflow-hidden bg-[#030914]/90 backdrop-blur-xl border-t border-white/10"
